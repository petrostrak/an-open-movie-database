...
func generateToekn(userID int64, ttl time.Duration, scope string) (*Token, error) {
	...
	// the CSPRNG fails to function properly.
	...
	// we use the WithPadding(base32.NoPadding) method in the line below toomit them.
